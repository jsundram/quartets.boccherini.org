...
Paths in sw.js's SHELL are repo-root-relative here ("./index.html" -> index.html), unlike the
haydn/pwa-starter layout where they sit under web/. Adapted from those repos' sw_lint.py.
